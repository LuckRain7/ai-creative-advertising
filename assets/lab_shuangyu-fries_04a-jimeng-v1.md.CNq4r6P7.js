...
<span class="line"><span>镜头固定不动。画面中不出现任何文字、logo。</span></span></code></pre></div><p><strong>验收</strong>：只弹跳一次、镜头不动；动作复杂了就废。</p><hr><h2 id="镜头-2-·-刀切入土豆-首尾帧" tabindex="-1">镜头 2 · 刀切入土豆（首尾帧） <a class="header-anchor" href="#镜头-2-·-刀切入土豆-首尾帧" aria-label="Permalink to &quot;镜头 2 · 刀切入土豆（首尾帧）&quot;">​</a></h2><p><strong>图像 · 首帧</strong>｜无参考图</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>一把厚背主厨刀的刀刃刚接触马铃薯表面，尚未切入，</span></span>
...
<span class="line"><span>16:9，高细节</span></span></code></pre></div><p><strong>图像 · 尾帧</strong>｜无参考图</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>主厨刀已切入马铃薯约三分之二，切面完整露出，</span></span>
...
<span class="line"><span>慢动作，镜头固定。画面中不出现任何文字、logo。</span></span></code></pre></div><p><strong>验收</strong>：切面乳白微黄、有汁水；切面发干发灰就废。</p><hr><h2 id="镜头-3-·-土豆条落下" tabindex="-1">镜头 3 · 土豆条落下 <a class="header-anchor" href="#镜头-3-·-土豆条落下" aria-label="Permalink to &quot;镜头 3 · 土豆条落下&quot;">​</a></h2><p><strong>图像 · 首帧</strong>｜无参考图</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>一把切好的马铃薯条悬停在空中，条形整齐但边缘带自然毛刺与不规则棱角，</span></span>
...
<span class="line"><span>慢动作，镜头固定。画面中不出现任何文字、logo。</span></span></code></pre></div><p><strong>验收</strong>：<strong>边缘带毛刺、棱角不规则 = 真土豆切的</strong>，这是「原薯鲜切」唯一的画面物证；出片边缘太规整，重跑。</p><hr><h2 id="镜头-4-·-真空舱内的低温油炸-首尾帧" tabindex="-1">镜头 4 · 真空舱内的低温油炸（首尾帧） <a class="header-anchor" href="#镜头-4-·-真空舱内的低温油炸-首尾帧" aria-label="Permalink to &quot;镜头 4 · 真空舱内的低温油炸（首尾帧）&quot;">​</a></h2><p><strong>图像 · 首帧</strong>｜无参考图</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>封闭金属舱室内部视角，透过观察窗看到清澈的浅金色食用油，</span></span>
